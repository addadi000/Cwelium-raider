...
## 📜 Legacy Information
<details>
<summary><strong>Cwelium (Archival)</strong></summary>
...
This program is distributed under the [AGPL v3.0](https://github.com/Tips-Discord/Cwelium/blob/main/LICENSE). Ensure proper credit is given to this project. It **Applies exclusively to legacy codebase**
